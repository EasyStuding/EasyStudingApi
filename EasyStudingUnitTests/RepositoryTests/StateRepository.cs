...
namespace EasyStudingUnitTests.RepositoryTests
{
    public class StateRepositoryTest
    {
        ...
        public async void StateRepository_Add_model_should_return_valid_model()
        {
            ...
            {
                var rep = new StateRepository(Context);
                var model = await rep.AddAsync(new State() { Id = 6 });
        ...
        public async void StateRepository_Edit_model_should_return_valid_model()
        {
            ...
            {
                var rep = new StateRepository(Context);
                var model = await rep.EditAsync(new State() { Id = 5 });
        ...
        public async void StateRepository_Edit_7_should_return_index_out_of_range_exception()
        {
            ...
            {
                var rep = new StateRepository(Context);
                var ex = await Assert.ThrowsAsync<IndexOutOfRangeException>(async () => await rep.EditAsync(new State() { Id = 7 }));
